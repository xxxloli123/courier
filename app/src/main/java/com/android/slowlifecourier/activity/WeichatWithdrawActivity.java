...
public class WeichatWithdrawActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weichat_withdraw);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.unbundling:
                Intent intent=new Intent(this,WeichatWithdrawActivity1.class);
                startActivity(intent);
                finish();
                break;
            case R.id.submit_bt:
                if(!Common.isNull(money.getText().toString().trim())){
                    progressDialog=new MyProgressDialog(this,"微信提现");
                    progressDialog.show();
                }
                break;
        }
