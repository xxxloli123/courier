package com.android.slowlifecourier.adressselectorlib;
...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    private int TextSelectedColor = Color.parseColor("#00A4FF");
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = R.color.blue;
    //列表icon资源
    ...
    private void init(Context context){
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.blue));
        addView(grayLine);
    ...
    private class Line extends LinearLayout{
        ...
        private int SelectedColor = Color.parseColor("#00A4FF");
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder viewHolder =
                    new MyViewHolder(LayoutInflater.from(mContext).inflate(
                            R.layout.item_select_area,parent,false));
            return viewHolder;
        }
