package com.android.slowlifecourier.http;
...
public class OkHttpCallback implements Callback {
    ...
    private static String message="showMessage都有错";
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Toast.makeText(impl.getContext(), "服务器连接错误", Toast.LENGTH_SHORT).show();
                    ...
                    public void run() {
                        try {
                            if (json.getInt("statusCode") == 200) {
                                ...
                                Toast.makeText(impl.getContext(), json.getString("message"),
    ...
    public static void showMessage(){
            Toast.makeText(impl.getContext(), message, Toast.LENGTH_SHORT).show();
    }
