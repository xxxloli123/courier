...
//        Drawable drawable = getResources().getDrawable(R.mipmap.ic_home_white_24dp);
//        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
//
//        tab.setCompoundDrawables(null, drawable, null, null);//设置TextView的drawableleft
//        tab.setCompoundDrawablePadding(1);//设置图片和text之间的间距
...
//        Drawable drawable1 = getResources().getDrawable(R.mipmap.ic_home_white_24dp);
//        drawable1.setBounds(0, 0, drawable1.getMinimumWidth(), drawable1.getMinimumHeight());
//
//        tab2.setCompoundDrawables(null, drawable1, null, null);//设置TextView的drawableleft
//        tab2.setCompoundDrawablePadding(1);//设置图片和text之间的间距
